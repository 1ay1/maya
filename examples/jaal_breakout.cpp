// examples/jaal_breakout.cpp — GENERATED from breakout.cpp by tools/port_canvas.py.
// Do not edit: change breakout.cpp and re-run the tool.
//
...
int main() {
    return run_canvas(CanvasConfig{.fps=60,.title="breakout"},rebuild,handle,paint);
}
