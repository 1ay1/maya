// examples/jaal_editor_ide.cpp — jaal port of examples/editor_ide.cpp (view unchanged).
//
...
static_assert(JaalView<IDE>);

int main() { return run_jaal<IDE>({.title = "maya editor — IDE layout"}); }
