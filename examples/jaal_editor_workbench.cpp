// examples/jaal_editor_workbench.cpp — jaal port of examples/editor_workbench.cpp (view unchanged).
//
...
static_assert(JaalView<App>);

int main() { return run_jaal<App>({.title = "maya editor — workbench"}); }
