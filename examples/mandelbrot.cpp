// examples/mandelbrot.cpp — an auto-zooming Mandelbrot set, as a jaal program.
//
...
static_assert(Program<Mandelbrot>);

}  // namespace

int main() { return run<Mandelbrot>({.title = "mandelbrot"}); }
