...
//   EastAsianWidth.txt — EastAsianWidth-16.0.0.txt
...
inline constexpr std::array<WidthRange, 122> kWideRanges {{
    {0x1100, 0x115F},
    {0x231A, 0x231B},
    {0x2329, 0x232A},
    {0x23E9, 0x23EC},
...
inline constexpr std::array<WidthRange, 80> kEmojiPresentationRanges {{
    {0x231A, 0x231B},
    {0x23E9, 0x23EC},
    {0x23F0, 0x23F0},
    {0x23F3, 0x23F3},
...
inline constexpr std::array<WidthRange, 367> kZeroWidthRanges {{
    {0x0300, 0x036F},
    {0x0483, 0x0489},
    {0x0591, 0x05BD},
    {0x05BF, 0x05BF},
