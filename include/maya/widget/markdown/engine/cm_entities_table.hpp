#pragma once
// cm_entities_table.hpp — GENERATED by scripts/gen_entities.py from the
// official WHATWG entities.json (HTML5 named character references).
// CommonMark §6.2 resolves these to their Unicode value. Do not edit by
// hand; re-run the generator to refresh.
//
// 2125 semicolon-terminated named entities.

#include <string_view>

namespace maya::md_detail::engine {

struct EntityRow { std::string_view name; std::string_view utf8; };

// Sorted by name for binary search.
inline constexpr EntityRow kEntities[] = {
    {"AElig", "\xc3\x86"},
    {"AMP", "\x26"},
    {"Aacute", "\xc3\x81"},
    {"Abreve", "\xc4\x82"},
...
inline constexpr int kEntityCount = 2125;
