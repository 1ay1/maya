...
inline constexpr HighlightTheme monokai = [] {
    HighlightTheme t{};
    using S = Style;
    auto hex = [](uint32_t v) { return Color::hex(v); };
    t.styles[capture_index(Capture::None)]        = S{}.with_fg(hex(0xF8F8F2));
    t.styles[capture_index(Capture::Keyword)]     = S{}.with_fg(hex(0xF92672));
    t.styles[capture_index(Capture::KeywordCtrl)] = S{}.with_fg(hex(0xF92672)).with_bold();
    t.styles[capture_index(Capture::Type)]        = S{}.with_fg(hex(0x66D9EF)).with_italic();
    t.styles[capture_index(Capture::Function)]    = S{}.with_fg(hex(0xA6E22E));
    t.styles[capture_index(Capture::String)]      = S{}.with_fg(hex(0xE6DB74));
    t.styles[capture_index(Capture::Number)]      = S{}.with_fg(hex(0xAE81FF));
    t.styles[capture_index(Capture::Comment)]     = S{}.with_fg(hex(0x75715E)).with_italic();
    t.styles[capture_index(Capture::Constant)]    = S{}.with_fg(hex(0xAE81FF));
    t.styles[capture_index(Capture::Operator)]    = S{}.with_fg(hex(0xF92672));
    t.styles[capture_index(Capture::Punctuation)] = S{}.with_fg(hex(0xF8F8F2));
    t.styles[capture_index(Capture::Preproc)]     = S{}.with_fg(hex(0xA6E22E));
    t.styles[capture_index(Capture::Attribute)]   = S{}.with_fg(hex(0xA6E22E));
    t.styles[capture_index(Capture::Variable)]    = S{}.with_fg(hex(0xF8F8F2));
    t.styles[capture_index(Capture::Property)]    = S{}.with_fg(hex(0x66D9EF));
    return t;
}();
...
inline constexpr HighlightTheme github_dark = [] {
    ...
    using S = Style;
    auto hex = [](uint32_t v) { return Color::hex(v); };
    t.styles[capture_index(Capture::None)]        = S{}.with_fg(hex(0xC9D1D9));
    t.styles[capture_index(Capture::Keyword)]     = S{}.with_fg(hex(0xFF7B72));
    t.styles[capture_index(Capture::KeywordCtrl)] = S{}.with_fg(hex(0xFF7B72));
    t.styles[capture_index(Capture::Type)]        = S{}.with_fg(hex(0xFFA657));
    t.styles[capture_index(Capture::Function)]    = S{}.with_fg(hex(0xD2A8FF));
    t.styles[capture_index(Capture::String)]      = S{}.with_fg(hex(0xA5D6FF));
    t.styles[capture_index(Capture::Number)]      = S{}.with_fg(hex(0x79C0FF));
    t.styles[capture_index(Capture::Comment)]     = S{}.with_fg(hex(0x8B949E)).with_italic();
    t.styles[capture_index(Capture::Constant)]    = S{}.with_fg(hex(0x79C0FF));
    t.styles[capture_index(Capture::Operator)]    = S{}.with_fg(hex(0xFF7B72));
    t.styles[capture_index(Capture::Punctuation)] = S{}.with_fg(hex(0xC9D1D9));
    t.styles[capture_index(Capture::Preproc)]     = S{}.with_fg(hex(0xFF7B72));
    t.styles[capture_index(Capture::Attribute)]   = S{}.with_fg(hex(0xD2A8FF));
    t.styles[capture_index(Capture::Variable)]    = S{}.with_fg(hex(0xC9D1D9));
    t.styles[capture_index(Capture::Property)]    = S{}.with_fg(hex(0x79C0FF));
    return t;
}();
